...
class DatePicker extends Component {
    ...
    _renderChildren = (props, onPressDate) => {
        ...
        return (
            React.createElement(View,
                ...
                React.Children.map(props.children, (child) => {
                    return React.cloneElement(child, {onPress: onPressDate});
                }))
        )
    }

    _renderiOSCalendar = (props) => {
                ...
                <TouchableOpacity
                    ...
                    <TouchableOpacity
                        ...
                        <Animated.View
                            ...
                            <View
                                pointerEvents={this.state.allowPointerEvents
                                    ? 'auto' : 'none'}>
    ...
    render() {
        ...
        return (
            <View style={props.style}>
                ...
                {
                    this._renderChildren(props, this.onPressDate)
                }

                {
                    Platform.OS === 'ios' && this._renderiOSCalendar(props)
                }
            </View>
        );
    }
